...
export function GetBlacklistStatus() {
  return window['go']['main']['App']['GetBlacklistStatus']();
}
...
export function IsEndpointBlacklisted(arg1) {
  return window['go']['main']['App']['IsEndpointBlacklisted'](arg1);
}
...
export function UpdateBlacklistConfig(arg1, arg2) {
  return window['go']['main']['App']['UpdateBlacklistConfig'](arg1, arg2);
}
