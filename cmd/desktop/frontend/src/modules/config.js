...
export async function addEndpoint(name, url, key, transformer, model, remark, priority) {
    await window.go.main.App.AddEndpoint(name, url, key, transformer, model, remark || '', priority || 5);
}

export async function updateEndpoint(index, name, url, key, transformer, model, remark, priority) {
    await window.go.main.App.UpdateEndpoint(index, name, url, key, transformer, model, remark || '', priority || 5);
}
